...
//        Sorted on the basis of values in reverse (a-->z)
    ...
    System.out.println("------------------------------------------------------------");
            ...
            System.out.println(map.entrySet().stream().filter(integerStringEntry -> mapSet.add(integerStringEntry.getValue())).collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue)));
    }
}
